...
class Hatke extends StatefulWidget {
   Hatke({super.key});

  @override
  State<Hatke> createState() => _HatkeState();
}

class _HatkeState extends State<Hatke> {
  String? data;
  var news_length;
  @override
  void initState() {
  ...
  void getData() async {
    http.Response response = await http
        .get(Uri.parse("https://inshorts.deta.dev/news?category=hatke"));
